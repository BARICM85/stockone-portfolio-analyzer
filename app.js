...
const BENCHMARK_NAMES = {
  ...
  NIFTYNXT50: "Nifty Next 50", MIDCPNIFTY: "Midcap Nifty", FINNIFTY: "Fin Nifty",
  NIFTYIT: "IT", NIFTYAUTO: "Auto", NIFTYPHARMA: "Pharma",
  NIFTYENERGY: "Energy", NIFTYFMCG: "FMCG", NIFTYMETAL: "Metal",
...
function displaySymbol(sym) {
  ...
  return DISPLAY_LABELS[sym] || BENCHMARK_NAMES[sym] || sym;
}

/* Which sectors/groups have expandable holdings */
const SECTOR_ETFS = new Set([
  "NIFTYIT","NIFTYAUTO","NIFTYPHARMA","NIFTYENERGY","NIFTYFMCG","NIFTYMETAL",
  "NIFTYREALTY","NIFTYPVTBANK","NIFTYPSUBANK","NIFTYMEDIA","NIFTYINFRA","NIFTYCOMMODITIES"
]);
...
async function loadData() {
  ...
  try {
    ...
    const subtitle = SECTOR_ETFS.has(state.benchmark)
      ...
      : `NSE Sector Indices vs ${benchLabel}`;
